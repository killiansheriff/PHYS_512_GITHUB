...
s = P.system_init(npart, size, init_mas, specific_r=None, specific_v=init_v)
...
pickle.dump((posi, energy), open("Q3_periodic.p", "wb"))

save_frames("Q3_periodic.p", 'Q3_Periodic', freq, gridsize)
create_gif('Q3_Periodic', niter, freq, duration=niter / freq)
plot_energy("Q3_periodic.p")
